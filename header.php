...
<header class="container-fluid site-header">
    ...
    if ( is_front_page() ) {
      ...
      echo '<iframe width="560" height="315" src="https://www.youtube.com/embed/MqMyk4hYg1s?autoplay=1&mute=1&controls=0&loop=1&playlist=MSu0NSMZuhs&amp;showinfo=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
      echo '</div>';
    } else {
